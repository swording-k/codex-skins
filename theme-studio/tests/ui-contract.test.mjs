...
assert.match(app, /Microsoft Store 版 Codex/, "Windows guidance tells users how the supported Store package is detected");
assert.doesNotMatch(app, /暂不支持启用主题/, "the UI does not claim that the supported Store Codex cannot use themes");
